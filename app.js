...
const profileContent = () => `
  <div class="content">
    ...
    <p>Outside of the sphere of computer science, I love creating videos about geography, culture, and moving abroad. I also enjoy playing piano and going to the gym. My favourite composers are Chopin, Liszt, and Rachmaninoff.</p>
...
const projectContent = () => `
  <div class="content"><span class="eyebrow">~/projects</span><h2></h2>
    <article class="project-card"><span class="project-mark">&gt;_</span><span class="eyebrow">AI agents / open source</span><h3>org-agent</h3><p>org-agent is a LangGraph workflow that enriches an organization profile from a company or organization name and a known website. The workflow uses Playwright to crawl information online. It is model agnostic and uses LLM decision capabilities as well as deterministic rules to achieve the best results. You can find more information on github.</p><div class="tags"><span>Python</span><span>LangGraph</span><span>Playwright</span><span>Ollama</span></div><div class="actions"><button class="button" data-command="open org-agent">Explore project →</button><a class="button secondary" href="${LINKS['org-agent']}" target="_blank" rel="noopener noreferrer">GitHub ↗</a></div></article>
    <article class="project-card"><span class="project-mark">✦</span><span class="eyebrow">Game development / team project</span><h3>2D arena platformer</h3><p>As part of a six-person team, we developed a 2D arena platformer that was voted second place by the community. I was responsible for all textures and animations.</p><div class="tags"><span>2D game</span><span>Textures & animations</span><span>2nd place · Community vote</span></div><div class="actions"><a class="button secondary" href="https://www.youtube.com/watch?v=x7SehSW_Z_k&amp;t=2910s" target="_blank" rel="noopener noreferrer">Watch 48:30–51:30 ↗</a><a class="button secondary" href="https://www.youtube.com/watch?v=x7SehSW_Z_k&amp;t=5970s" target="_blank" rel="noopener noreferrer">Watch 1:39:30–1:40:00 ↗</a></div></article>
...
function executeCommand(raw) {
  ...
  if (["cat", "open", "xdg-open"].includes(lower) && fileMatch) {
    ...
    output("Projects: org-agent · 2D arena platformer · Gaussian Splatting · Monocular Depth Estimation", "success");
    openWindow("projects");
